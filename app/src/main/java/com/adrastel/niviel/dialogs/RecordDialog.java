    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        if(record != null) {
            ...
            if(record.getSingle() != null && !record.getSingle().trim().equals("")) {
                ...
                single.setText(Assets.fromHtml(String.format(getString(R.string.record_time), Assets.wrapStrong(record.getSingle()))));
                nr_single.setText(Assets.fromHtml(String.format(getString(R.string.record_nr), Assets.wrapStrong(record.getNr_single()))));
                cr_single.setText(Assets.fromHtml(String.format(getString(R.string.record_cr), Assets.wrapStrong(record.getCr_single()))));
                wr_single.setText(Assets.fromHtml(String.format(getString(R.string.record_wr), Assets.wrapStrong(record.getWr_single()))));
            }
            ...
            if(record.getAverage() != null && !record.getAverage().trim().equals("")) {
                ...
                average.setText(Assets.fromHtml(String.format(getString(R.string.record_time), Assets.wrapStrong(record.getAverage()))));
                nr_average.setText(Assets.fromHtml(String.format(getString(R.string.record_nr), Assets.wrapStrong(record.getNr_average()))));
                cr_average.setText(Assets.fromHtml(String.format(getString(R.string.record_cr), Assets.wrapStrong(record.getCr_average()))));
                wr_average.setText(Assets.fromHtml(String.format(getString(R.string.record_wr), Assets.wrapStrong(record.getWr_average()))));
            }
        }
